...
const template = (cartItems, totalPrice, removeFromCart) => html`
...
export function cartView(ctx) {
  ...
  async function removeFromCart(id) {
    try {
      ...
      // Show error message
      ctx.render(
        template(cartItems, totalPrice, removeFromCart),
        error.message
      );
    }
  }
  ...
  const cartTemplate = template(cartItems, totalPrice, removeFromCart);
